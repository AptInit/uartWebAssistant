# UART Web Assistant
I needed a serial terminal with XMODEM support that works for any reasonable OS, so I vibed this.

The following is generated by AI, just like the rest of this repository.
